package com.ivc.nikstanov.organizationservice.exception;
...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<ErrorDetails> handleEmailAlreadyExistsException(OrganizationAlreadyExistsException exception,
                                                                        WebRequest webRequest){
